...
import { Image, ListView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
      ...
      <View style={{ flex: 1 }}>
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.matches}>
            <Text style={{ color: '#da533c', fontWeight: '600', fontSize: 12 }}>THIS PARTY'S BUZZING WITH BAD
              BITCHES</Text>
            <ListView
              horizontal={true}
